          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="http://localhost/rentaldb/accounting/PayOfferRent.php?p=1">Back</a></li>
      ...
      <div class="card card-solid">
        <div class="card-body">
          ...
          <br><div class="row justify-content-center">
              <div class="row">
                <a class="btn btn-success btn-lg" data-slide="true" href="PayProcess.php?rent=<?php echo $rent?>&dpayid=<?php echo $payid?>" role="button">
                    <i class="nav-icon fas fa-edit"></i> 
                    ยืนยันความถูกต้อง    
                </a>
              </div>
          ...
          <?php }else{ ?>
            <br><div class="row justify-content-center">
              <div class="row">
                <a class="btn btn-success btn-lg disabled" data-slide="true" href="PayProcess.php?dpayid=<?php echo $payid?>" role="button">
                    <i class="nav-icon fas fa-edit"></i> 
                    ยืนยันความถูกต้อง    
                </a>
              </div>
