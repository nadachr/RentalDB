...
<?php 
    function searchDP(){
        ...
        $query = mysqli_query($conn, "CALL searchDNotPay('$search', $start, $perpage)");
        $resultArray = array();
    ...
    function searchMP(){
      ...
      $query = mysqli_query($conn, "CALL searchMNotPay('$search', $start, $perpage)");
      $resultArray = array();
            ...
            <div class="col-md-12">
              <div class="card card-primary">
                ...
                <div class="card-body p-0">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>รอชำระเงิน</td>
                        <td align="center">
                          <a class="btn btn-info" data-slide="true" href="PayDNodetail.php?rent=<?php echo $row['DRentID']?>&pay=<?php echo $row['DPayID']?>" role="button">
                  ...
                  <?php 
                    $perpage = 5;
                    $sql = "SELECT * FROM dpayment WHERE DPayEnvi is NULL;";
                  ...
                  <div class="card-footer clearfix">
                    <nav>
                      <ul class="pagination pagination0sm m-0 float-right">
                        <li class="page-item">
                          <a class="page-link" href="PayOfferRentNot.php?p=1" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a>
                        </li>
                        <?php for($i=1;$i<=$total_page;$i++){ ?>
                        <li class="page-item"><a class="page-link" href="PayOfferRentNot.php?p=<?php echo $i?>"><?php echo $i;?></a></li>
                        <?php } ?>
                        <li class="page-item">
                          <a class="page-link" href="PayOfferRentNot.php?p=<?php echo $total_page?>" aria-label="Next"> <span aria-hidden="true">&raquo;</span></a>
                        </li>
                      </ul>
                    </nav>
                  </div>
            ...
            <div class="col-md-12">
              <div class="card card-warning">
                ...
                <div class="card-body p-0">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>รอชำระเงิน</td>
                        <td align="center">
                          <a class="btn btn-info" data-slide="true" href="PayMNodetail.php?rent=<?php echo $row['MRentID']?>" role="button">
                            <i class="nav-icon fas fa-info-circle"></i>
                          </a>
                        </td>
                      </tr>
                  ...
                  <?php 
                    $perpage = 5;
                    $sql = "SELECT * FROM MPayment WHERE MPayEnvi is NULL;";
                    $query2 = mysqli_query($conn, $sql);
                    $total_record = mysqli_num_rows($query2);
                    $total_page = ceil(($total_record / $perpage));
                  ?>
