                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card">
                                ...
                                <div class="card-body">
                                    <div class="row justify-content-center">
                                        <h2>แบบฟอร์มการขอเช่าสถานที่ราชการ (ตัวอย่าง)</h2>
                                    </div>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <label class="lead text-primary"><?php echo $row["AccTName"];?> ตัวอย่าง</label>
                                            </div>
                                            <div class="form-group">
                                                <label>รหัสประจำตัวประชาชน</label>
                                                <?php foreach($fetchAcc as $result){ ?>
                                                <label class="lead text-primary"><?php echo $result["AccID"];?> ตัวอย่าง</label>
                                                <?php } ?>
                                            </div>
                                            <div class="form-group">
                                                <label>เบอร์ติดต่อ</label>
                                                <?php foreach($fetchAcc as $result){ ?>
                                                <label class="lead text-primary"><?php echo $result["AccPhone"];?> ตัวอย่าง</label>                                          <?php } ?>
                                            </div>
                                        </div>
                                        <div class="col-md-6">    <!-----left row form------->
                                            <div class="form-group">
                                                <label>สังกัด</label>
                                                <?php foreach($fetchAcc as $result){ ?>
                                                <label class="lead text-primary"><?php echo $result["AccInst"];?> ตัวอย่าง</label>
                                                <?php } ?>
                                            </div>
                                            <div class="form-group">
                                                <label>ที่อยู่</label>
                                                <?php foreach($fetchAcc as $result){ ?>
                                                <label class="lead text-primary"><?php echo $result["AccAddress"];?> ตัวอย่าง</label>
                                                <?php } ?>
                                            </div>
                                            <div class="form-group">
                                                <label>E-mail</label>
                                                <?php foreach($fetchAcc as $result){ ?>
                                                <label class="lead text-primary"><?php echo $result["LogEmail"];?> ตัวอย่าง</label>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div> 
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="form-group">
                                            <a class="btn btn-info btn-lg disabled" data-slide="true" href="DailyRentSent.php?dprent=<?php echo $DPlace?>&accno=<?php echo $AccNo?>" role="button" onclick="return confirm('กรอกรายละเอียดการเช่าสถานที่ราชการ');">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="form-group">
                                        &emsp;<a class="btn btn-success btn-lg disabled" data-slide="true" href="DailyRentDetail.php" role="button" onclick="return confirm('กรอกรายละเอียดการขอเช่าสถานที่ราชการ');">
                                          ต่อไป <i class="nav-icon far fa-arrow-alt-circle-right"></i>
                                            </a>
                                        </div>
                                    </div>
