          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="http://localhost/rentaldb/accounting/DailyRental/DRentMN.php?p=1">Back</a></li>
                        ...
                        <div class="card card">
                            ...
                            <form role="form" action="DailyRentSent.php" method="POST">
                              ...
                              <div class="card-body">
                                ...
                                <div class="row justify-content-center">
                                  <div class="form-group">
                                    <a href="http://localhost/rentaldb/accounting/DailyRental/DRentMN.php?p=1" class="btn btn-primary btn-lg" name="sent"><i class="nav-icon fas fa-arrow-left"></i> ย้อนกลับ</a>
                                  </div>
                                </div>
                              </div>
                            </form>
