<?php 
    ...
    if((isset($_GET['accno']))&(isset($_GET['place']))){
        $accno = $_GET['accno'];
        $place = $_GET['place'];
        ...
        function fetchOffer($accno, $place){
            include "connrent.php";
            
            $query = mysqli_query($conn, "SELECT * FROM vofferdetail WHERE AccNo = $accno AND MPlaceID = $place;");
            $resultArray = array();
        ...
        $fetchOffer = fetchOffer($accno, $place);
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <h4><b>&emsp;ดำเนินการเสนอราคาค่าเช่าสถานที่เรียบร้อยแล้ว</b> </h4>
                                            </div>
                                            <div class="row justify-content-center">
                                                <div class="col-md-10">
                                                    <div class="form-group">
                                    ...
                                    <!---<div class="row justify-content-center">
                                        <div class="form-group">
                                            <a class="btn btn-primary btn-lg" data-slide="true" href="DailyPay.php?dprent=<?php echo $RentID?>" role="button">
                                                <i class="nav-icon fas fa-print"></i> พิมพ์หน้านี้
                                            </a>
                                        </div>&emsp;
                                    </div>-->
                                </div>
