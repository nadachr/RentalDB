          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a class="text-danger" href="http://localhost/rentaldb/accounting/MonthlyRental/MPlaceDetail.php?show=<?php echo $MPlace?>">back</a></li>
                <li class="breadcrumb-item active"><a href="http://localhost/rentaldb/accounting/MonthlyRental/MonthlyOffer.php">เลือกสถานที่ใหม่</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="form-group">
                                            <a class="btn btn-info btn-lg" data-slide="true" href="MOfferSent.php?mprent=<?php echo $MPlace?>&accno=<?php echo $AccNo?>" role="button" onclick="return confirm('กรอกรายละเอียดการเสนอประมูลสถานที่');">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="form-group">
                                            <a class="btn btn-info btn-lg" data-slide="true" href="MonthlyType.php?p=1" role="button" onclick="return confirm('ตรวจสอบรายละเอียดการเช่าสถานที่ราชการ');">
                                            <i class="nav-icon fas fa-warehouse"></i> ดูสถานที่ 
                                            </a>
                                        </div>
                                        <div class="form-group">
                                        &emsp;<a class="btn btn-success btn-lg" data-slide="true" href="MOfferDetail.php" role="button" onclick="return confirm('ตรวจสอบรายละเอียดการเช่าสถานที่ราชการ');">
                                          ต่อไป <i class="nav-icon far fa-arrow-alt-circle-right"> </i>
                                            </a>
                                        </div>
                                    </div>
