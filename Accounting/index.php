...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <?php 
    ...
    function fetchDR(){
      include "connrent.php";
      $query = mysqli_query($conn, "SELECT COUNT(*) FROM dpayment WHERE DPayEnvi is NULL");
      $resultArray = array();
    ...
    function fetchMR(){
      include "connrent.php";
      $query = mysqli_query($conn, "SELECT COUNT(*) FROM mpayment WHERE MPayEnvi is NULL");
      $resultArray = array();
                ...
                <li class="nav-item">
                  <a href="http://localhost/rentaldb/accounting/DailyRental/DRentMN.php?p=1" class="nav-link">
                    ...
                    <?php foreach($fetchDR as $row){
                      if ($row["COUNT(*)"]){ $_SESSION['countDR'] = $row['COUNT(*)'];?>
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="http://localhost/rentaldb/accounting/index.php">Home</a></li>
            ...
            <div class="col-lg-6 col-6">
              ...
              <div class="small-box bg-lightblue">
                <div class="inner">
                  ...
                  <p><h5>รอชำระเงิน</h5></p>
                </div>
                <div class="icon">
                  <i class="fas fa-cash-register"></i>
                </div>
                <a href="PayOfferRentNot.php?p=1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-6 col-6">
              ...
              <div class="small-box bg-purple">
                ...
                <a href="PayOfferRent.php?p=1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
          </div>
          <!-- /.row -->
