            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">รายการผู้ลงทะเบียนใหม่</h3>
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a class="btn btn-info" data-slide="true" href="UserDetailEdit.php?show=<?php echo $row['AccNo']?>" role="button">
