                                ...
                                <div class="card-body">
                                    ...
                                    <?php }else{ ?>
                                        <div class="form-group">
                                                    ...
                                                    <?php } ?>
                                                    ได้ทำการเช่า
                                                    <?php foreach($fetchR as $result){ ?>
                                                    <u><?php echo $result['DPlaceNo'].' '.$result["DPlaceTName"];?></label><?php } ?></u>
                                                    ซึ่งตั้งอยู่ที่
                                                    <?php foreach($fetchR as $result){ ?>
                                                    <u><?php echo $result["LocTName"];?></label><?php } ?></u><br>
                                            </h5>
                                            <h5>&emsp;&emsp;&emsp;เป็นระยะเวลา <?php foreach($fetchR as $result){ ?>
                                                    <u class="text-danger"><?php echo $result["DRentDay"];?></label><?php } ?></u>
                                                วัน ซึ่งคิดเป็นมูลค่าทั้งหมด</h5>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="form-group">
                                            <a class="btn btn-info btn-lg" data-slide="true" href="DailyPay.php?dprent=<?php echo $RentID?>" role="button" onclick="return confirm('ชำระค่าเช่าสถานที่');">
                                                <i class="nav-icon fas fa-cash-register"></i> ชำระเงิน
                                            </a>
                                        </div>
                                    </div>
