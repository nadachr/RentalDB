...
<?php 
    function searchDP(){
        ...
        $query = mysqli_query($conn, "CALL searchDailyPlace($pType, '$search', $start, $perpage)");
        $resultArray = array();
          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="DailyType.php">Back</a></li>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title"><?php echo $row['DTTName'];?></h3>
                ...
                <div class="card-body p-0">
                  <table class="table table-striped">
                    ...
                    <tbody>
                      <?php
                        foreach($fetchDP as $row){
                          if($row['DPlaceStatus'] == 1){
                      ?>
                      <tr>
                        <td><?php $i++; echo $i; ?></td>
                        <td><?php echo $row["DPlaceNo"]; ?></td>
                        <td><?php echo $row["DPlaceTName"]; ?></td>
                        <td><?php echo $row["DPlaceEName"]; ?></td>
                        <td><?php echo $row["LocID"]; ?></td>
                        <td><?php echo $row["LocTName"]; ?></td>
                        <td align="center">
                          <a class="btn btn-info" data-slide="true" href="DPlaceDetail.php?show=<?php echo $row['DPlaceID']?>" role="button">
                            <i class="nav-icon fas fa-info-circle"></i>
                          </a>
                        </td>
                        <td align="center">
                          <a class="btn btn-danger" data-slide="true" href="editDPlace.php?p=<?php echo $p?>&placehid=<?php echo $row['DPlaceID']?>&show=<?php echo $pType?>" role="button" onclick="return confirm('ยืนยันการซ่อนข้อมูล');">
                      ...
                      <tr>
                        ...
                        <td class="text-danger"><?php echo $row["DPlaceNo"]; ?></td>
                        <td class="text-danger"><?php echo $row["DPlaceTName"]; ?></td>
                        <td class="text-danger"><?php echo $row["DPlaceEName"]; ?></td>
                        ...
                        <td align="center">
                          <a class="btn btn-success" data-slide="true" href="editDPlace.php?p=<?php echo $p?>&placeshow=<?php echo $row['DPlaceID']?>&show=<?php echo $pType?>" role="button" onclick="return confirm('ยืนยันการแสดงข้อมูล');">
                  ...
                  <div class="card-footer clearfix">
                    <nav>
                      <ul class="pagination pagination0sm m-0 float-right">
                        <li class="page-item">
                          <a class="page-link" href="DailyPlace.php?p=1&show=<?php echo $pType ?>" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a>
                        </li>
                        <?php for($i=1;$i<=$total_page;$i++){ ?>
                        <li class="page-item"><a class="page-link" href="DailyPlace.php?p=<?php echo $i?>&show=<?php echo $pType ?>"><?php echo $i;?></a></li>
                        <?php } ?>
                        <li class="page-item">
                          <a class="page-link" href="DailyPlace.php?p=<?php echo $total_page?>&show=<?php echo $pType ?>" aria-label="Next"> <span aria-hidden="true">&raquo;</span></a>
                        </li>
                      </ul>
                    </nav>
                  </div>
                ...
                <form role="form" action="editDPlace.php" method="POST">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="input" class="form-control" value="" name="placeNo" placeholder="หมายเลขสถานที่">
                    </div>
                    <div class="form-group">
