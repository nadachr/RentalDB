    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Place Rental Management System</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-lightblue">
                <div class="inner">
                  <h3>53<sup style="font-size: 15px"> ข้อเสนอ</sup>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-purple">
                <div class="inner">
                  <h3>44<sup style="font-size: 15px"> รายการ</sup></h3>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-pink">
                <div class="inner">
                  <h3>65<sup style="font-size: 15px"> บัญชี</sup></h3>
