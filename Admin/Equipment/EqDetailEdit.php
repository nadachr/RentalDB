...
<?php 
    ...
    if(isset($_POST['upload'])){
        ...
        header("location: EquipDetail.php?show=$Equip");
    }
?>
    ...
    <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-8">
              <h1>รายละเอียดอุปกรณ์เสริม : <?php echo $row['EqTName'];?></h1>
            </div>
            <div class="col-sm-4">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="Equipment.php">Back</a></li>
        ...
        <div class="card-body">
          <div class="row">
            <div class="col-12 col-sm-6">
              ...
              <div class="col-12">
                <img src="http://localhost/rentaldb/personel/equipment/img/<?php echo $row['EqImg'];?>" class="product-image" alt="Product Image">
              </div>
              <div class="col-12 product-image-thumbs">
                <div class="product-image-thumb active"><img src="http://localhost/rentaldb/personel/equipment/img/<?php echo $row['EqImg'];?>" alt="Product Image"></div>
              </div>
              <form active="" method="post" enctype="multipart/form-data"> 
                <div class="col-12 product-image-thumbs">
                  <input type="file" value="<?php echo $row['EqImg'];?>" name="img" class="form-control-file border"> 
                  <input type="submit" class=" btn bg-primary btn-flat" name="upload" value="Upload" onclick="return confirm('ยืนยันการแก้ไขรูปภาพ');"> 
                </div>
              </form>
            </div>
            <div class="col-12 col-sm-6">
              <h2 class="my-3"><?php echo $row["EqTName"] ?></h2>
              <h3><?php echo $row["EqEName"] ?></h3>
              <hr>              
              <h4><i class="fas fa-info-circle"></i> รายละเอียด <small>Description</small>
                <label class="btn btn-default text-center">
                    <span class="text-xm">อุปกรณ์ดังกล่าวมีจำนวนจำกัดในการยืม ขอความร่วมมือในการดูแลรักษา</span>
                </label>
              </h4>
              <hr> 
              ...
              <div class="bg-lightblue py-2 px-3 mt-4">
                ...
                <h2 class="mb-0">
                  <?php echo $row["EqPrivate"] ?> บาท/วัน
                </h2>
              </div>

              <div class="mt-4 product-share">
                <a class="btn btn-danger" data-slide="true" href="EquipDetail.php?show=<?php echo $Equip?>" role="button">
                    <i class="nav-icon fas fa-edit"></i> 
                    ยกเลิก    
                </a>
              </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-warning">
                            ...
                            <form role="form" action="editEquip.php" method="POST">
                                <input type="hidden" name="page" value="<?php echo $Equip?>">
                                <input type="hidden" name="EqID" value="<?php echo $row['EqID']?>">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="equipT">ชื่ออุปกรณ์</label>
                                        <input type="input" class="form-control" value="<?php echo $row["EqTName"];?>" name="equipT" placeholder="ชื่อสถานที่">
                                    </div>
                                    <div class="form-group">
                                        <label for="equipE">Equipment Name</label>
                                        <input type="input" class="form-control" value="<?php echo $row["EqEName"];?>" name="equipE" placeholder="Place Name">
                                    </div>
                                    <div class="form-group">
                                        <label for="agency">ค่าเช่าหน่วยงานราชการ</label>
                                        <input type="input" class="form-control" value="<?php echo $row["EqAgency"];?>" name="agency" placeholder="บาท/วัน">
                                    </div>
                                    <div class="form-group">
                                        <label for="private">ค่าเช่าหน่วยงานเอกชน</label>
                                        <input type="input" class="form-control" value="<?php echo $row["EqPrivate"];?>" name="private" placeholder="บาท/วัน">
                                    </div>
                                    <div class="form-group">
