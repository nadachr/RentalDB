                  ...
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        ...
                        <th style="width: 150px">เปิด/ปิดประมูล</th>
                      </tr>
                    </thead>
                    <tbody>
                      <?php
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a class="btn btn-danger" data-slide="true" href="editMPlace.php?p=<?php echo $p?>&placehid=<?php echo $row['MPlaceID']?>&show=<?php echo $pType?>" role="button" onclick="return confirm('ยืนยันการปิดประมูล');">
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <a class="btn btn-success" data-slide="true" href="editMPlace.php?p=<?php echo $p?>&placeshow=<?php echo $row['MPlaceID']?>&show=<?php echo $pType?>" role="button" onclick="return confirm('ยืนยันการเปิดประมูล');">
