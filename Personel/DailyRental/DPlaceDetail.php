          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="mt-4">
                ...
                <a class="btn btn-info btn-lg" data-slide="true" href="http://localhost/rentaldb/personel/DailyRental/DRentMN.php?p=1&dprent=<?php echo $row["DPlaceTName"]?>" role="button">
              ...
              <div class="mt-4 product-share">
                <a class="btn btn-warning" data-slide="true" href="DPDetailEdit.php?pedit=<?php echo $row['DPlaceID']?>#move" role="button">
                    <i class="nav-icon fas fa-edit"></i> 
                    Edit    
                </a>
              </div>
