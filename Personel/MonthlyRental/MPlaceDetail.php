          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="mt-4">
                ...
                <a class="btn btn-info btn-lg" data-slide="true" href="http://localhost/rentaldb/personel/MonthlyRental/MOfferRent.php?p=1&dprent=<?php echo $row['MPlaceTName']?>" role="button">
              ...
              <div class="mt-4 product-share">
                <a class="btn btn-warning" data-slide="true" href="MPDetailEdit.php?pedit=<?php echo $row['MPlaceID']?>#move" role="button">
                    <i class="nav-icon fas fa-edit"></i> 
                    Edit    
                </a>
              </div>
