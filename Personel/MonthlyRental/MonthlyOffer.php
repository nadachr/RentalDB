          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="http://localhost/rentaldb/personel/MonthlyRental/MonthlyOffer.php?p=1">Refresh</a></li>
                <li class="breadcrumb-item active"><a href="http://localhost/rentaldb/personel/MonthlyRental/MonthlyType.php?p=1">จัดการสถานที่</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a class="btn btn-warning" data-slide="true" href="MonthlyPlace.php?p=1&show=<?php echo $place['MTID']?>" role="button" onclick="return confirm('แก้ไขข้อมูลสถานที่');">
                            <i class="nav-icon fas fa-edit"></i>
                          </a>
                        </td>
                      </tr> 
