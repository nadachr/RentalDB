          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-4">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a class="text-danger" href="http://localhost/rentaldb/personel/MonthlyRental/MPlaceDetail.php?show=<?php echo $MPlace?>">back</a></li>
                <li class="breadcrumb-item active"><a href="http://localhost/rentaldb/personel/MonthlyRental/MonthlyOffer.php">เลือกสถานที่ใหม่</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
