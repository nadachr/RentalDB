                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="form-group">
                                                    <a class="btn btn-success btn-lg" data-slide="true" href="http://localhost/rentaldb/boards/MonthlyRental/MonthlyPay.php?offer=<?php echo $offerid?>&rent=<?php echo $RentID?>&accno=<?php echo $accno?>" role="button">
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="form-group">
                                                    <a class="btn btn-primary btn-lg" data-slide="true" href="http://localhost/rentaldb/boards/index.php" role="button">
