          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6">
              ...
              <div class="mt-4">
                ...
                <a class="btn btn-info btn-lg" data-slide="true" href="http://localhost/rentaldb/boards/MonthlyRental/MOfferRent.php?p=1&dprent=<?php echo $row['MPlaceTName']?>" role="button">
