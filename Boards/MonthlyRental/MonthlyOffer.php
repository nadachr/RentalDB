          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="http://localhost/rentaldb/boards/MonthlyRental/MonthlyOffer.php?p=1">Refresh</a></li>
                <li class="breadcrumb-item active"><a href="http://localhost/rentaldb/boards/MonthlyRental/MonthlyType.php?p=1">จัดการสถานที่</a></li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
