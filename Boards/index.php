...
<body class="hold-transition sidebar-mini layout-fixed">
  ...
  <?php 
    ...
    function fetchMR(){
      include "connrent.php";
      $query = mysqli_query($conn, "SELECT COUNT(*) FROM monthlyoffer WHERE MOfferResult = 'wait';");
      $resultArray = array();
          ...
          <div class="row">
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-olive">
                ...
                <a href="http://localhost/rentaldb/boards/DailyRental/DRentMN.php?p=1" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-4 col-6">
              ...
              <div class="small-box bg-lightblue">
                <div class="inner">
                  ...
                  <p><h5>ข้อเสนอประมูลรอพิจารณา</h5></p>
                </div>
                <div class="icon">
                  <i class="fas fa-file-import"></i>
                </div>
