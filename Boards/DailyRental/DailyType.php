          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="DailyType.php">Refresh</a></li>
          ...
          <div class="row justify-content-center">
                  ...
                  <table class="table table-striped">
                    ...
                    <tbody>
                      ...
                      <tr href='#'>
                        <td><?php $x++;
                                  echo $x; ?></td>
                        <td><?php echo $row["DTTName"]; ?></td>
                        <td><?php echo $row["DTEName"]; ?></td>
                        <td><?php echo $row["DTSeat"]; ?></td>
                        <td><?php echo $row["DTPrivate"]; ?></td>
                        <td><?php echo $row["DTAgency"]; ?></td>
                        <td>
                          <a class="btn btn-info" data-slide="true" href="DailyPlace.php?p=1&show=<?php echo $row['DTID']?>" role="button">
                            <i class="nav-icon fas fa-info-circle"></i>
                          </a>
                        </td>
                        <td>
                          <a class="btn btn-warning" data-slide="true" href="DailyType.php?p=<?php echo $_GET['p']?>&edit=<?php echo $row['DTID']?>#here" role="button">
                            <i class="nav-icon fas fa-edit"></i>
                          </a>
                        </td>
                        <td align="center">
                          <a class="btn btn-danger" data-slide="true" href="editDType.php?p=<?php echo $_GET['p']?>&hid=<?php echo $row['DTID']?>" role="button" onclick="return confirm('ยืนยันการซ่อนข้อมูล');">
                      ...
                      <tr href='#'>
                        ...
                        <td class="text-danger"><?php echo $row["DTTName"]; ?></td>
                        <td class="text-danger"><?php echo $row["DTEName"]; ?></td>
                        <td class="text-danger"><?php echo $row["DTSeat"]; ?></td>
                        <td class="text-danger"><?php echo $row["DTPrivate"]; ?></td>
                        <td class="text-danger"><?php echo $row["DTAgency"]; ?></td>
                        <td>
                          <a class="btn btn-info" data-slide="true" href="DailyPlace.php?p=1&show=<?php echo $row['DTID']?>" role="button">
                            <i class="nav-icon fas fa-info-circle"></i>
                          </a>
                        ...
                        <td align="center">
                          <a class="btn btn-success" data-slide="true" href="editDType.php?p=<?php echo $_GET['p']?>&push=<?php echo $row['DTID']?>" role="button" onclick="return confirm('ยืนยันการแสดงข้อมูล');">
                  ...
                  <div class="card-footer clearfix">
                    <nav>
                      <ul class="pagination pagination0sm m-0 float-right">
                        <li class="page-item">
                          <a class="page-link" href="DailyType.php?p=1" aria-label="Previous"> <span aria-hidden="true">&laquo;</span></a>
                        </li>
                        <?php for($i=1;$i<=$total_page;$i++){ ?>
                        <li class="page-item"><a class="page-link" href="DailyType.php?p=<?php echo $i?>"><?php echo $i;?></a></li>
                        <?php } ?>
                        <li class="page-item">
                          <a class="page-link" href="DailyType.php?p=<?php echo $total_page?>" aria-label="Next"> <span aria-hidden="true">&raquo;</span></a>
                        </li>
                      </ul>
                    </nav>
                  </div>
            ...
            <div class="col-md-4">
              ...
              <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form role="form" action="editDType.php" method="POST">
